package com.woodwave.common.log;
...
public class LoggingAdvice {
	...
	@Before("execution(* com.woodwave.*.service.*.*(..)) || "
			+ "execution(* com.woodwave.*.dao.*.*(..))")
	...
	@After("execution(* com.woodwave.*.service.*.*(..)) || "
			+ "execution(* com.woodwave.*.*.dao.*.*(..))")
	...
	@Around("execution(* com.woodwave.*.service.*.*(..)) || "
			+ "execution(* com.woodwave.*.dao.*.*(..))")
